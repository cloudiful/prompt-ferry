-- P1 (issue #589): add the OpenAI Platform upstream provider alongside
-- generic/MiniMax/CommandCode/OpencodeGo/OpenRouter/GLM/DeepSeek. OpenAI
-- endpoints carry no provider_region (like the other non-MiniMax presets)
...
CHECK (provider IN ('generic', 'minimax', 'command_code', 'opencode_go', 'openrouter', 'glm', 'deepseek', 'openai'));
