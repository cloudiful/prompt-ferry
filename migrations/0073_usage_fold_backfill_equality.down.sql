-- Reverse 0073_usage_fold_backfill_equality.
--
-- This migration only rewrites the stored `input_tokens` of the equality-shape
-- folded rows missed by 0072 (those with `cache_read_tokens > 0` AND
-- `total_tokens >= output_tokens` AND
-- `input_tokens >= total_tokens - output_tokens`). The rewritten value is the
