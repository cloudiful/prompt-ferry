-- P1 (issue #203): add the OpenRouter upstream provider alongside
-- generic/MiniMax/CommandCode/OpencodeGo. OpenRouter endpoints carry no
-- provider_region (like generic, command_code and opencode_go) and never
-- gain the MiniMax builtin MCP privilege; region/MCP enforcement lives in
-- the admin handler layer, these CHECKs are the DB backstop.
...
CHECK (provider IN ('generic', 'minimax', 'command_code', 'opencode_go', 'openrouter'));
