-- P1 (issue #193): add the OpencodeGo upstream provider alongside
-- generic/MiniMax/CommandCode. OpencodeGo endpoints carry no provider_region
-- (like generic and command_code) and never gain the MiniMax builtin MCP
-- privilege; region/MCP enforcement lives in the admin handler layer, these
