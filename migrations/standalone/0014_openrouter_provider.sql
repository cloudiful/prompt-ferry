-- P1 (issue #203): mirror the PostgreSQL 0074 provider widening for the
...
CREATE TABLE standalone_provider_endpoints_new (
    ...
    provider TEXT NOT NULL CHECK (provider IN ('generic', 'minimax', 'command_code', 'opencode_go', 'openrouter')),
