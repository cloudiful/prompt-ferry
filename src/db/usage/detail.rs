...
struct RequestRecordDetailRow {
    ...
    http_request_compressed: Option<bool>,
    ...
    request_has_previous_response_id: Option<bool>,
...
impl From<RequestRecordDetailRow> for RequestRecordDetail {
    fn from(row: RequestRecordDetailRow) -> Self {
        Self {
            ...
            http_request_compressed: row.http_request_compressed.unwrap_or(false),
            ...
            request_has_previous_response_id: row.request_has_previous_response_id.unwrap_or(false),
