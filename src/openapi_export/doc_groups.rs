...
use super::{
    ...
    mcp::{
        ...
        __path_delete_mcp_server, __path_delete_quota_group, __path_get_mcp_catalog,
        __path_list_mcp_servers, __path_list_quota_groups, __path_list_server_credentials,
        __path_quota_group_usage, __path_test_mcp_server, __path_update_mcp_server,
        __path_update_quota_group, bind_credential_group, create_mcp_server, create_quota_group,
        delete_mcp_server, delete_quota_group, get_mcp_catalog, list_mcp_servers,
        list_quota_groups, list_server_credentials, quota_group_usage, test_mcp_server,
        update_mcp_server, update_quota_group,
    },
    me::{
    ...
    settings::{
        ...
        __path_get_model_route_whitelist, __path_get_raw_object_store,
        __path_get_redaction_setting, __path_get_relay_ip_whitelist,
        __path_get_request_content_logging, __path_get_stream_delta_batching,
        __path_get_usage_retention, __path_list_redaction_custom_strings, __path_preview_redaction,
...
use crate::{
    ...
    worker_admin_types::{
        ...
        ClientKeyPageResponse, CommandCodeBalances, CommandCodeWindowUsage,
        ConversationEndpointOverrideRequest, CreateClientKeyRequest, CreateClientKeyResponse,
        CreateUserRequest, CredentialPageResponse, CredentialQuotaBindingRequest, DeepSeekBalance,
        EndpointPageResponse, EndpointRequest, EndpointSettingRequest, EndpointTestResponse,
        ManagedRelay, ManagedRelayListResponse, ManagedRelayPatchRequest, ManagedRelayRequest,
        ManagedRelaySecretPatch, ManagedRelayStatus, McpCatalogItem, McpCatalogResponse, McpServer,
        McpServerPageResponse, McpServerRequest, McpTestResponse, MeResponse,
        ModelRoutePageResponse, ModelRouteRequest, ModelRouteTargetRequest, ModelRouteTestRequest,
        ModelRouteTestResponse, ModelRouteWhitelistRequest, ModelRouteWhitelistResponse,
        OpenRouterBalance, OpenRouterSpend, OpencodeGoWindowUsage, QuotaGroupRequest,
        QuotaGroupUsageResponse, RawObjectStoreBackend, RawObjectStoreSecretPatch,
        ...
        SessionAffinityResetResponse, SessionAffinityState, SessionAffinityStatus,
        SessionRouteOptionsResponse, TokenPlanKeyUsage, TokenPlanModelUsage,
...
#[openapi(
    paths(
        ...
        request_record_reset_session_affinity,
        request_record_full,
    ...
    components(
        schemas(
            ...
            ErrorEnvelope,
            LlmReviewSettings,
            RawObjectStoreBackend,
            RawObjectStoreSecretPatch,
