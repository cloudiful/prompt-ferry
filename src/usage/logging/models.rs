...
impl UsageLog {
    pub(crate) fn into_standalone_summary(self) -> StandaloneUsageSummary {
        ...
        StandaloneUsageSummary {
            ...
            session_header_id: bounded_text(self.session_header_id, STANDALONE_SUMMARY_TEXT_LIMIT),
            session_parent_id: bounded_text(self.session_parent_id, STANDALONE_SUMMARY_TEXT_LIMIT),
    ...
    fn base(
        ...
        Self {
            ...
            session_header_id: metadata.session_header_id,
            session_parent_id: metadata.session_parent_id,
...
pub(crate) struct StandaloneUsageSummary {
    ...
    pub(crate) session_header_id: Option<String>,
    pub(crate) session_parent_id: Option<String>,
...
impl From<&StandaloneUsageSummary> for crate::standalone_config::StandaloneUsageSummaryRecord {
    fn from(summary: &StandaloneUsageSummary) -> Self {
        Self {
            ...
            session_header_id: summary.session_header_id.clone(),
            session_parent_id: summary.session_parent_id.clone(),
...
impl From<&crate::standalone_config::StandaloneUsageSummaryRecord> for StandaloneUsageSummary {
    fn from(record: &crate::standalone_config::StandaloneUsageSummaryRecord) -> Self {
        Self {
            ...
            session_header_id: record.session_header_id.clone(),
            session_parent_id: record.session_parent_id.clone(),
