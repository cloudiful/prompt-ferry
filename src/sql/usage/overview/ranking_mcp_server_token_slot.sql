SELECT
    ...
    COALESCE('Token #' || rr.mcp_bearer_token_slot::TEXT, '(unknown)') AS secondary_label,
    rr.endpoint_id,
    rr.model,
    rr.mcp_server_id,
...
GROUP BY rr.mcp_server_id, rr.mcp_server_name, ms.name, rr.mcp_bearer_token_slot,
         rr.endpoint_id, rr.model
