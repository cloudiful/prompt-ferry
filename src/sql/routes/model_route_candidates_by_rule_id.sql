SELECT r.rule_id, r.scope, r.owner_user_id, r.model_pattern, r.routing_strategy,
       ...
       t.target_id, e.endpoint_id, e.name AS endpoint_name, e.base_url, e.api_key, e.proxy_url, e.key_lb_enabled, e.native_api, e.provider, COALESCE(e.service_tier, 'standard') AS service_tier,
