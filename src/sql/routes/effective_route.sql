...
SELECT e.endpoint_id AS "route_id!", $1::BIGINT AS "user_id!", e.base_url, e.api_key, e.proxy_url, e.key_lb_enabled, e.native_api, e.provider, COALESCE(e.service_tier, 'standard') AS service_tier
FROM selected s
