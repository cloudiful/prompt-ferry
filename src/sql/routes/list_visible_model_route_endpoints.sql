SELECT DISTINCT ON (e.endpoint_id) e.endpoint_id, e.base_url, e.api_key, e.proxy_url, e.key_lb_enabled, e.native_api, e.provider, COALESCE(e.service_tier, 'standard') AS service_tier
