INSERT INTO standalone_model_route_targets (
    ...
    active_windows, dev_system_normalize, thinking_downgrade_enabled, thinking_effort_override, compact_mode,
    updated_at
...
ON CONFLICT(target_id) DO UPDATE SET
    ...
    dev_system_normalize = excluded.dev_system_normalize,
    thinking_downgrade_enabled = excluded.thinking_downgrade_enabled,
    thinking_effort_override = excluded.thinking_effort_override,
