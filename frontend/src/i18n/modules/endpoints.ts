export const endpointMessages = {
  'zh-CN': {
    ...
    reasoningReplayPolicy: 'Reasoning 恢复',
    reasoningReplayPolicyAuto: '自动',
    reasoningReplayPolicyForceReplay: '强制补齐',
    reasoningReplayPolicyForcePassthrough: '强制透传',
    passthroughOff: '回放',
    passthroughOn: '透传',
  ...
  'en-US': {
    ...
    reasoningReplayPolicy: 'Reasoning replay',
    reasoningReplayPolicyAuto: 'Auto',
    reasoningReplayPolicyForceReplay: 'Force replay',
    reasoningReplayPolicyForcePassthrough: 'Force passthrough',
